...
articleDataFromJson(ArticleData data, Map<String, dynamic> json) {
	...
	if (json['originId'] != null) {
		data.originId = json['originId']?.toString();
	}
	if (json['prefix'] != null) {
	...
	if (json['tags'] != null) {
		data.tags = new List<ArticleDatasTag>();
		(json['tags'] as List).forEach((v) {
			data.tags.add(new ArticleDatasTag().fromJson(v));
		});
	}
	if (json['title'] != null) {
...
articleDatasTagFromJson(ArticleDatasTag data, Map<String, dynamic> json) {
	if (json['name'] != null) {
...
Map<String, dynamic> articleDatasTagToJson(ArticleDatasTag entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
